      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-5 gap-8">
        ...
        <aside className="lg:col-span-1 space-y-8">
          <div className="p-6 bg-primary/10 rounded-[2rem] text-center group">
            ...
            <h2 className="font-black text-xl italic tracking-tighter text-base-content">
              Engine Room
            </h2>
          </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <section className="bg-base-200 p-8 md:p-12 rounded-[2.5rem] shadow-2xl border border-base-content/5 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center md:text-left">
              ...
              <p className="text-sm font-bold opacity-40 uppercase tracking-[0.2em] mb-10">
                Inject a URL to extract intelligence
              </p>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-5 duration-700">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {articles.map((item) => (
                  <div
                    key={item._id}
                    className="bg-base-200 p-5 rounded-[2rem] border border-base-content/5 shadow-md flex flex-col justify-between group"
                  >
                    <div>
                      <h3 className="font-bold text-lg mb-2 leading-tight group-hover:text-primary transition-colors line-clamp-2 italic">
                        {item.title}
                      </h3>
                      <p className="text-xs opacity-50 line-clamp-3 leading-relaxed font-medium">
                        {item.summary}
                      </p>
                    </div>
                    <div className="pt-4 mt-4 border-t border-base-content/5 flex justify-end">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs font-black uppercase text-primary flex items-center gap-1 hover:gap-2 transition-all"
                      >
